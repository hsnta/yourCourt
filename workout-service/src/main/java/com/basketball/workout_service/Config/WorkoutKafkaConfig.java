...
@Configuration
public class WorkoutKafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, DrillCreationRequest> drillCreationProducerFactory() {
    ...
    public KafkaTemplate<String, DrillCreationRequest> drillKafkaTemplate() {
        return new KafkaTemplate<>(drillCreationProducerFactory());
    }
