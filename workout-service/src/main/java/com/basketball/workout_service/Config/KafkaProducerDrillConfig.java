...
@Configuration
public class KafkaProducerDrillConfig {

    @Bean(name = "drillProducerFactory")
    public ProducerFactory<String, DrillCreationRequest> drillProducerFactory() {
    ...
    @Bean(name = "drillKafkaTemplate")
    public KafkaTemplate<String, DrillCreationRequest> drillKafkaTemplate() {
        return new KafkaTemplate<>(drillProducerFactory());
    }
