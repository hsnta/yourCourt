...
public class GatewayConfig {
    ...
    @Value(value = "${your_court.base_path}")
    String basePath;
    @Value(value = "${your_court.gateway.apollo_service_port}")
    String apolloGatewayPort;
    @Value(value = "${your_court.https_enabled}")
    ...
    public RouteLocator routes(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("apollo-gateway", r -> r.path("/graphiql").uri("http://192.168.0.24:4000"))
